...
const property: PropertyData = {
  ...
  imageUrl: "https://picsum.photos/id/1040/600/400" // Architecture/Castle/House
};
      ...
      <div className="bg-black/30 rounded-xl overflow-hidden border border-white/10 group cursor-pointer hover:border-gold/30 transition-all duration-300">
        ...
        <div className="p-4">
          ...
          <div className="flex justify-between items-center mt-2">
            ...
            <button className="text-xs text-white border border-white/30 px-3 py-1 rounded hover:bg-white hover:text-black transition-colors">
              Ver Detalhes
            </button>
          </div>
        </div>
